...
You can donwload the sample grassopper definition used in this guide [here](https://ifchoppershell.github.io/grasshopper-documentation/files/Hopper_Script.gh), and the sample output file [here](https://ifchoppershell.github.io/grasshopper-documentation/files/Hopper_File.ifc).
