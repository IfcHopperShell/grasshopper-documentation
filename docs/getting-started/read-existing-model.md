...
<p align="center">
  <img src="/grasshopper-documentation/img/read_model_and_version.png" />
</p>
...
<p align="center">
  <img src="/grasshopper-documentation/img/get_mesh_with_colors.png" />
</p>

<p align="center">
  <img src="/grasshopper-documentation/img/get_mesh_with_colors_2.png" />
</p>

You can also inlcude only certain element classes, in this case only `IfcWall` elements were included.
<p align="center">
  <img src="/grasshopper-documentation/img/get_mesh_with_colors_3.png" />
</p>

<p align="center">
  <img src="/grasshopper-documentation/img/get_mesh_with_colors_4.png" />
</p>
...
<p align="center">
  <img src="/grasshopper-documentation/img/get_info_by_step_id_guid_type_1.png" />
</p>

Let's get the element with guid `20FpTZCqJy2vhVJYtjuIce`. In this case the `IfcSite`.

<p align="center">
  <img src="/grasshopper-documentation/img/get_info_by_step_id_guid_type_2.png" />
</p>
...
<p align="center">
  <img src="/grasshopper-documentation/img/get_info_by_step_id_guid_type_3.png" />
</p>